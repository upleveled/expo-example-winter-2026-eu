# UpLeveled Expo example

Example project demonstrating features of React Native, Expo and Postgres.js including how to build REST APIs.
...
![Screenshot of home screen, showing a list of animals](./screenshot-homescreen.avif)
